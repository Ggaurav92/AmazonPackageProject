...
public class LoginTest {
 ...
 public void ScenarioOne(String usrnm, String pswd, String expstring, String Invldemail, String InvlPass,
   String ValidPhnNo, String InvalidPhnNo) throws InterruptedException, IOException {
	 ...
	 befMethod(); // This is Beforemethod used for Integration purpose only
  //Report related code
...
*/
 ...
 public void beforeClass() {
  System.setProperty("webdriver.chrome.driver",
    "C:\\Training\\Drivers\\chromedriver.exe");
 ...
 //This method is used instead of beforemethod for integration
